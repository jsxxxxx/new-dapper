          ...
          {releases.map((release, index) => (
            <div key={index} className="relative group">
              <div className="relative p-8 bg-background border-2 border-primary/50 rounded-2xl group-hover:border-primary group-hover:shadow-[0_0_30px_rgba(168,85,247,0.15)] transition-all duration-500 h-full overflow-hidden flex flex-col">
                ...
                <div className="w-14 h-14 bg-primary/10 border-2 border-primary/20 rounded-xl flex items-center justify-center mb-6 transition-all group-hover:border-primary group-hover:scale-110">
                ...
                <div className="mt-auto relative z-10 flex items-center justify-between border-t border-primary/20 pt-4">
                  <div className="inline-block px-3 py-1 bg-primary/10 text-primary text-sm font-bold border-l-2 border-primary rounded-r-lg">
                    {release.timeline}
                  </div>
        ...
        <div className="mt-16 text-center">
          <div className="bg-background border-2 border-primary rounded-2xl p-8 max-w-4xl mx-auto shadow-[0_0_40px_rgba(168,85,247,0.1)]">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <div className="inline-flex items-center px-3 py-1 text-sm font-medium bg-primary text-primary-foreground border border-primary rounded-full">
